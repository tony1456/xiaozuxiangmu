...
mysqli_query($link, 'CREATE DATABASE login');//创建数据库

mysqli_query($link, 'use login');//选择数据库
...
$act = $_POST['act'];//登录或注册字段

$user = strtolower($_POST['user']);//获取输入的账号,转成小写

$pass = $_POST['pass'];//获取输入的密码
